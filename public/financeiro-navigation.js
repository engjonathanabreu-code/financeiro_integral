...
const icons={dashboard:'layout-dashboard',accounts:'wallet',institutionalClients:'users',erpProjects:'clipboard-list',documents:'files',cashflow:'arrow-left-right',budgets:'calculator',trips:'plane',invoices:'request-approval',planning:'clipboard-list',reports:'chart-no-axes-combined',receivables:'receipt',hr:'contact',registers:'folder-cog',users:'users',recebimentos:'receipt'};
let pending=false;
